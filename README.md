...
version `zprint 1.2.2`) perform essentially the same operations as lein zprint.
You can do:
```
$ zprint -w *.clj
```
...
Place `[lein-zprint "1.2.2"]` into the `:plugins` vector of your project.clj:

```
:plugins [[lein-zprint "1.2.2"]]
```
